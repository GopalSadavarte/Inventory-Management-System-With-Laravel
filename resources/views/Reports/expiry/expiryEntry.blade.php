@extends('template') @push('title') Purchase Entry @endpush
@section('main-section')
<div class="bg-light px-4 my-2 py-2 shadow rounded mx-4 h-100">
    <div class="mt-2 d-flex">
        <h3 class="heading">Expiry Entry</h3>
    ...
    <form id="expiryEntryForm" method="post" action="{{ route('expiry.store') }}">
            ...
            <div class="d-flex">
                <div class="row g-5 col-12">
                    ...
                    <div class="d-flex my-auto col-12">
                        ...
                        <div class="col-2 mx-2">
                            <label for="dateUpTo">Expiry Up-To</label>
                            <input type="date" name="expiryUpTo" id="expiryUpTo" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="mt-2 col-12 row mx-auto">
            ...
            <div class="col-2 mx-0">
                <label for="stockAmt">Stock Amt.</label>
                <input
                    type="text"
                    name="stockAmt"
                    id="stockAmt"
...
@section('bottom-script-section')
    <script type="module" src="{{asset('js/expiry.js')}}"></script>
@endsection
