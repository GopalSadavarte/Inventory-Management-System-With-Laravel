...
<div class="bg-light px-4 my-2 py-2 shadow rounded mx-4 h-100">
    <div class="mt-2 d-flex">
        <h3 class="heading">Purchase Entry</h3>
    ...
    <form id="purchaseEntryForm" method="post" action="{{ route('purchase.store') }}" onsubmit="submitForm()">
        @csrf
        <span id="method"></span>
        <div class="content">
            <div class="d-flex">
...
@section('bottom-script-section')
    <script type="module" src="{{ asset('js/purchase.js') }}"></script>
@endsection
